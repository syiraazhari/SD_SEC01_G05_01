          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Staff ID/Admin ID</label>
                  <div class="col-sm-10">
                    
                    <?php
                      echo '<input type="text" name="staffId" class="form-control" >';
                    ?>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                      ...
                      <?php
                      echo '<input type="text" name="userType" value = "Admin" class="form-control" readonly>';
                    ?>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <button type="submit" class="btn btn-primary"  name="addAdminAccount">Add Admin Account</button>
                  </div>
                </div>
