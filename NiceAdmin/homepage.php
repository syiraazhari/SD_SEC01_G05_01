                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>Muhammad Faiz Zakwan (STUDENT)</td>
                        <td><a href="#" class="text-primary">Bilik Bilik Ilmuan 1</a></td>
                        <td>RM 125</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#26</a></th>
                        <td>Nur Syahira Amira Binti Mohd Azhari (LECTURER)</td>
                        <td><a href="#" class="text-primary">Bilik Bankuet</a></td>
                        <td>RM 100</td>
                        <td><span class="badge bg-warning">Pending</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#27</a></th>
                        <td>Tan Chee Sen (STUDENT)</td>
                        <td><a href="#" class="text-primary">Bilik Ilmuan 3 </a></td>
                        <td>RM 125</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#28</a></th>
                        <td>Danesh A/L Muthukhrisnan (STUDENT)</td>
                        <td><a href="#" class="text-primar">Dewan Jumaah</a></td>
                        <td>RM 250</td>
                        <td><span class="badge bg-danger">Rejected</span></td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#">#29</a></th>
                        <td>Aviniish Devar A/L Nadarajan (STUDENT)</td>
                        <td><a href="#" class="text-primary">Dewan Kuliah</a></td>
                        <td>RM 135</td>
                        <td><span class="badge bg-success">Approved</span></td>
                      </tr>
                    </tbody>
            ...
            <div class="col-12">
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">Top Bookings <span>| Today</span></h5>
                  ...
                  <table class="table table-borderless">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/Dewan-Azman-Hashim.png" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Dewan Azham Hashim</a></td>
                        <td>RM 4000 / per day</td>
                        <td class="fw-bold">Available</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/Bilik-Ilmuan-2.png" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Bilik Ilmuan 2</a></td>
                        <td>RM1700 / per day</td>
                        <td class="fw-bold">Available</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/Bilik-Ilmuan-3.png" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Bilik Ilmuan 3</a></td>
                        <td>RM 1200 / per day</td>
                        <td class="fw-bold">Unavailable</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/BasketBallCourt.png" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Basketball Court</a></td>
                        <td>RM 300 / per day</td>
                        <td class="fw-bold">Available</td>
                      </tr>
                      <tr>
                        <th scope="row"><a href="#"><img src="assets/img/TennisCourt.png" alt=""></a></th>
                        <td><a href="#" class="text-primary fw-bold">Tennis Court</a></td>
                        <td>RM 300 / per day</td>
                        <td class="fw-bold">Unavailable</td>
                      </tr>
                    </tbody>
              ...
              <div class="activity">
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Bilik ilmuan 3 is closed for maintenance.
                  </div>
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    Tennis Court has been booked for 1 day.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    User has send their enquiries through the chat box.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                    The payment RM500 has been made.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                      Dewan Seminar has been booked for 1 day.
                  </div>
                </div><!-- End activity item-->
                ...
                <div class="activity-item d-flex">
                  ...
                  <div class="activity-content">
                      Dewan Jumaah is closed for maintenance.
                  </div>
                </div><!-- End activity item-->
