...
function displaySearchPanel()
{
    ...
    echo'<br><fieldset style="text-align: center"><legend><b>Search facility</b></legend>';
    echo'<b>Search Key: </b>';
    echo'<br><input type="text" name="searchKey">';
    echo'<br><br><input class="button button2" type="submit" name="searchByFacilityId" value="By Facility Id">';
    echo'<input class="button button2" type="submit" name="searchByName" value="By Name">';
    echo'<input class="button button2" type="submit" name="searchByCategory" value="By Category">';
    echo'<input class="button button2" type="submit" name="displayAll" value="Display All">';
    echo'</fieldset>';
    echo'</form>';
    echo'</div>';
